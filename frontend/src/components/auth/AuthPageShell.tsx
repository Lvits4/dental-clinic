...
const AuthPageShell = ({
  ...
  <div className={`mx-auto w-full ${maxWidthClass}`}>
    <div className="overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-[0_24px_80px_-12px_rgba(15,23,42,0.12)] dark:border-slate-800 dark:bg-slate-900 dark:shadow-[0_24px_80px_-12px_rgba(0,0,0,0.45)] lg:rounded-3xl lg:border-0 lg:bg-transparent lg:shadow-none dark:lg:bg-transparent dark:lg:shadow-none">
      ...
      <div className="relative bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 px-6 py-10 text-center lg:hidden">
        <div
        ...
        <div className="relative flex flex-col items-center">
          <img 
            src={logoInicio} 
            alt="SmileCare" 
            className="h-20 w-auto max-w-[6rem] object-contain drop-shadow-lg" 
          />
          <p className="mt-3 text-xl font-bold tracking-tight text-white">SmileCare</p>
          <p className="mt-0.5 text-sm text-emerald-100/90">Gestion dental en un solo lugar</p>
        </div>
      </div>
