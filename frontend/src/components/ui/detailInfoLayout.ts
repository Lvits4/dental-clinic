...
export const DETAIL_INFO_TILE_CLASS =
  'rounded-xl border border-slate-200/80 dark:border-slate-700 bg-slate-50/80 dark:bg-slate-800/30 p-4';

export const DETAIL_INFO_SECTION_TITLE_CLASS =
  'text-sm font-semibold text-slate-800 dark:text-white mb-4';

export const DETAIL_INFO_GRID_CLASS = 'grid grid-cols-1 sm:grid-cols-2 gap-4';
