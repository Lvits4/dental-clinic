      ...
      <div>
        ...
        >
          <span className="flex items-center gap-2">
            ...
            Filtros
            {hasFilters && <span className="ml-1 px-1.5 py-0.5 text-xs bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 rounded">activos</span>}
          </span>
          <svg
